  ...
  return (
    <div className="text-center mb-1">
      ...
      <div className="space-y-0">
        <span className="text-[15px] font-normal text-white tracking-[0.2em] uppercase block mb-10">
      ...
      <p className="text-white text-xs mt-1 font-normal tracking-wide uppercase">
