  ...
  return (
    <div className="flex justify-between items-center bg-white/[0.02] hover:bg-white/[0.05] p-3 rounded-xl border border-white/5 transition-all group">
      <div className="min-w-0 flex-1">
        <p className="text-sm font-normal text-white truncate">{p.name}</p>
        <div className="flex items-center gap-4 mt-1.5">
          ...
          {p.isSubmitted ? (
            <span className="flex items-center gap-1.5 text-[9px] font-normal text-white uppercase bg-white/5 px-2 py-0.5 rounded-full border border-white/10">
              <div className="w-1 h-1 rounded-full bg-white shadow-[0_0_4px_white]" /> Finished
            </span>
          ) : p.isDisconnected ? (
            <span className="flex items-center gap-1.5 text-[9px] font-normal text-white uppercase bg-white/[0.02] px-2 py-0.5 rounded-full border border-white/5">
              Lost
            </span>
          ) : (
            <span className="flex items-center gap-1.5 text-[9px] font-normal text-white/60 uppercase animate-pulse">
               Solving...
            </span>
          )}
        </div>
